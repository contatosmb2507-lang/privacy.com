...
(function () {
  ...
  // ─── Criar cobrança Pix ─────────────────────────────────────────────────────
  function createPixCharge(product, name, email) {
    var payload = { amount: product.amount, description: product.description, name: name, email: email };
  ...
  function openStep2(product, name, email) {
    var m = document.getElementById('checkout-modal');
    ...
    createPixCharge(product, name, email)
  ...
  function injectModal() {
    ...
    document.getElementById('btn-pagar').addEventListener('click', function () {
      ...
      openStep2(m._product, name, email);
    });
  }
